...
<html lang="en">
    ...
    <div class="container" style=" ">
    	<div class="col-md-5">
    		<form action="masuk.php" method="POST">
    			<h1><label for="exampleInputEmail1">Silahkan LogIn</label></h1>
  ...
  <div class="form-group">
    ...
    <input type="password" name="repassword" class="form-control" id="exampleInputPassword1" placeholder="RePassword">
  </div>
  ...
  <button type="submit" name="submit" class="btn btn-primary">Submit</button>
   ...
   Sudah Punya akun? <a href="index.php"> SignIn</a>
  </center></body>
